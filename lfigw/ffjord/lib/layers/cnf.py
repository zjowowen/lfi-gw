...
class CNF(nn.Module):
    def __init__(self, odefunc, conditional=False, T=1.0, train_T=False, regularization_fns=None, solver='dopri5', atol=1e-5, rtol=1e-5):
    ...
    def forward(self, z, logpz=None, context=None, integration_times=None, reverse=False):
